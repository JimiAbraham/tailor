...
<div class="section">
  <h5 class="pagetitle">All Your Clients</h5>
      </div>
</div>
      ...
      <div class="nav-wrapper">
        <form action="{{ route('search-client')}}" method="POST">
          ...
          <div class="input-field">
            <input  name="search" type="search" placeholder="Search Clients" required>
...
<p>{{ $client->job}} </p>
 ...
 <div class="secondary-content">
  ...
  <h2><center>{{ $clients->links("pagination::bootstrap-4") }}</center></h2>
    ...
    <div class="row ">
      <div class="col s12 pad-0">                  
        <div class="card-panel red lighten-1">
          <span class="white-text">You are yet to add any of your clients on board!.</span>
        </div>
</div>
</div>
  @endif
